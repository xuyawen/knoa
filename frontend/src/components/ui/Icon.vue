...
// 图标层：kebab name -> lucide-vue-next 组件。lucide 默认 stroke=currentColor、
// stroke-width=2、round linecap/join、24x24，与旧内联 SVG 视觉一致。
// 显式 import 保 tree-shake，不 import * 全量。
...
import {
  ...
  Presentation, FileType, Filter, RefreshCw, Eye, LayoutGrid, BarChart3, Users, Table,
  Flame, Clock, History, List, Globe, UsersRound, CircleDot, Link2, MessageCircle, PanelLeftClose, PanelLeftOpen,
  ...
  Layers, Crosshair, Image as ImageIcon, Scan, GripVertical, Activity, ScrollText,
...
const ICONS: Record<string, Component> = {
  ...
  file: File, excel: FileSpreadsheet, pptx: Presentation,   pdf: FileType, filter: Filter,
  refresh: RefreshCw, eye: Eye, grid: LayoutGrid, chart: BarChart3, users: Users,
  fire: Flame, clock: Clock, history: History, list: List, globe: Globe, team: UsersRound,
  node: CircleDot, link: Link2, collapse: PanelLeftClose, 'panel-left-open': PanelLeftOpen, 'chevrons-right': ChevronsRight, expand: Maximize2, attach: Paperclip,
  'file-text': FileText, 'file-type': FileType, 'file-code': FileCode, table: Table, message: MessageCircle, quote: Quote,
